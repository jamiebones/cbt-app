...
import testSessionRoutes from './modules/testSessions/routes.js';
import testEnrollmentRoutes from './modules/testEnrollment/routes.js';
...
app.use('/api/test-enrollments', testEnrollmentRoutes);
